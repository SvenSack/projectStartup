Shader "Custom/CelShaded"
{
    ...
    SubShader
    {
        ...
        half4 LightingCelShaded (SurfaceOutputCelShaded s, half3 lightDir, half3 viewDir, half atten) {
            ...
            half diff = round(saturate(0.7 * nDotL / _LightCutoff ) * _ShadowBands) / _ShadowBands;
            ...
            float3 rim = -_RimColor * _RimColor * step(1 - _RimSize ,1 - saturate(dot(normalize(viewDir), s.Normal)));
